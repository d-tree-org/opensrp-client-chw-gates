...
public class AtReferralDetailsViewActivity extends ReferralDetailsViewActivity {
    ...
    public static void startReferralDetailsViewActivity(Activity activity, MemberObject memberObject, CommonPersonObjectClient client) {
        Intent intent = new Intent(activity, AtReferralDetailsViewActivity.class);
    ...
    public void setUpViews() {
        ...
        this.clientName = (CustomFontTextView)this.findViewById(R.id.client_name);
        this.careGiverName = (CustomFontTextView)this.findViewById(R.id.care_giver_name);
        this.careGiverPhone = (CustomFontTextView)this.findViewById(R.id.care_giver_phone);
        this.clientReferralProblem = (CustomFontTextView)this.findViewById(R.id.client_referral_problem);
        this.referralDate = (CustomFontTextView)this.findViewById(R.id.referral_date);
        this.referralFacility = (CustomFontTextView)this.findViewById(R.id.referral_facility);
        this.preReferralManagement = (CustomFontTextView)this.findViewById(R.id.pre_referral_management);
