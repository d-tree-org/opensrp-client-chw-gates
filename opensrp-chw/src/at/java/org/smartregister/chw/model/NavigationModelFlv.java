...
public class NavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        if (navigationOptions.size() == 0) {
            ...
            NavigationOption op5 = new NavigationOption(R.mipmap.sidemenu_referrals, R.mipmap.sidemenu_referrals_active, R.string.menu_referrals, Constants.DrawerMenu.REFERRALS, 0);
            navigationOptions.addAll(Arrays.asList(op1, op3, op2, op4, op5));
        }
